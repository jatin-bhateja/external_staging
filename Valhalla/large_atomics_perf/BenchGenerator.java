...
public class BenchGenerator  {
   ...
   public static String getModeString(int mode) {
       switch(mode) {
           case 0 : return "Strict atomic update without @LooselyConsistentValue";
           case 1 : return "Allow non-atomic update with @LooselyConsistentValue";
           case 2 : return "Enforce no field flattening";
   ...
   public static void main(String [] args) throws Exception {
       ...
       System.out.println("[Bench marking mode] => " + getModeString(mode));
