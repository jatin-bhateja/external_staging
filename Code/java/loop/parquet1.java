...
class BitUnpack7Vector {
    ...
    private static void test1() throws Exception {
        ...
        System.out.println(String.format("test1 result: vector2_spent_time=%s", vector2_spent_time));
    }
    ...
    private static void test2() throws Exception {
        ...
        System.out.println(String.format("test2 result: vector2_spent_time=%s", vector2_spent_time));
    }
}
