...
// CommandLine: -Xbatch -XX:CompileThresholdScaling=0.3 -XX:+PauseAtStartup -XX:CompileOnly=TestDeoptInLarvalState::micro -XX:CompileCommand=DontInline,TestDeoptInLarvalState::cleanup -XX:+PrintDeoptimizationDetails --add-exports=java.base/jdk.internal.misc=ALL-UNNAMED -cp . TestDeoptInLarvalStateNoInline
...
public class TestDeoptInLarvalStateNoInline {
