...
# test.cpp:9:     std::cout << "Argument type : " << typeid(arr).name() << "\nReturn type : " << typeid(T).name() << std::endl;
	mov	rbx, QWORD PTR _ZTIPi[rip+8]	# iftmp.1_74, MEM[(const char * *)&_ZTIPi + 8B]
...
.L5:
	...
	call	_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@PLT	#
# test.cpp:9:     std::cout << "Argument type : " << typeid(arr).name() << "\nReturn type : " << typeid(T).name() << std::endl;
	mov	rbp, QWORD PTR _ZTIi[rip+8]	# iftmp.1_79, MEM[(const char * *)&_ZTIi + 8B]
# /usr/include/c++/7/typeinfo:100:     { return __name[0] == '*' ? __name + 1 : __name; }
...
# /usr/include/c++/7/ostream:561: 	__ostream_insert(__out, __s,
	...
	call	_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@PLT	#
# test.cpp:9:     std::cout << "Argument type : " << typeid(arr).name() << "\nReturn type : " << typeid(T).name() << std::endl;
	mov	rbp, QWORD PTR _ZTIPl[rip+8]	# iftmp.1_55, MEM[(const char * *)&_ZTIPl + 8B]
# /usr/include/c++/7/typeinfo:100:     { return __name[0] == '*' ? __name + 1 : __name; }
...
.L12:
	...
	call	_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@PLT	#
# test.cpp:9:     std::cout << "Argument type : " << typeid(arr).name() << "\nReturn type : " << typeid(T).name() << std::endl;
	mov	rbp, QWORD PTR _ZTIl[rip+8]	# iftmp.1_60, MEM[(const char * *)&_ZTIl + 8B]
# /usr/include/c++/7/typeinfo:100:     { return __name[0] == '*' ? __name + 1 : __name; }
...
# /usr/include/c++/7/ostream:561: 	__ostream_insert(__out, __s,
	...
	call	_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@PLT	#
# test.cpp:9:     std::cout << "Argument type : " << typeid(arr).name() << "\nReturn type : " << typeid(T).name() << std::endl;
	mov	rbp, QWORD PTR _ZTIPf[rip+8]	# iftmp.1_36, MEM[(const char * *)&_ZTIPf + 8B]
# /usr/include/c++/7/typeinfo:100:     { return __name[0] == '*' ? __name + 1 : __name; }
...
.L19:
	...
	call	_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@PLT	#
# test.cpp:9:     std::cout << "Argument type : " << typeid(arr).name() << "\nReturn type : " << typeid(T).name() << std::endl;
	mov	rbp, QWORD PTR _ZTIf[rip+8]	# iftmp.1_41, MEM[(const char * *)&_ZTIf + 8B]
# /usr/include/c++/7/typeinfo:100:     { return __name[0] == '*' ? __name + 1 : __name; }
...
# /usr/include/c++/7/bits/locale_facets.h:877: 	return this->do_widen(__c);
	...
	lea	rcx, _ZNKSt5ctypeIcE8do_widenEc[rip]	# tmp212,
	mov	esi, 10	#,
...
# /usr/include/c++/7/bits/locale_facets.h:877: 	return this->do_widen(__c);
	...
	lea	rcx, _ZNKSt5ctypeIcE8do_widenEc[rip]	# tmp266,
	mov	esi, 10	#,
...
# /usr/include/c++/7/bits/locale_facets.h:877: 	return this->do_widen(__c);
	...
	lea	rcx, _ZNKSt5ctypeIcE8do_widenEc[rip]	# tmp239,
	mov	esi, 10	#,
