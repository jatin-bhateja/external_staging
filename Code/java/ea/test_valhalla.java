...
value class PlaneCoordinates {
    ...
    public PlaneCoordinates affine_transform(float scale, float offset) {
        return new PlaneCoordinates(x * scale + offset, y * scale + offset);
    }
...
public class test_valhalla {
    ...
    public static float transform(float x, float y, int cond) {
        ...
        if (cond > 1000) {
            ...
            inst = inst.affine_transform(3.0f, 5.0f);
        }
