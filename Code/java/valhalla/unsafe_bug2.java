...
public class unsafe_bug2 {
    ...
    /*public static Pair micro(AbstractPair a) {
        a = Unsafe.getUnsafe().makePrivateBuffer(a);
        Pair ca = (Pair)a;
        Unsafe.getUnsafe().putDouble(ca, 16, 20.0);
        return Unsafe.getUnsafe().finishPrivateBuffer(ca);
    }*/
