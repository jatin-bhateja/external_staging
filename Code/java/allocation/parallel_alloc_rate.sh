...
############################################
# 1. GC-derived allocation rate (ParallelGC)
############################################

# Expected format:
# [0.456s][info][gc] GC(12) Pause Young (Allocation Failure) 512M->64M(1024M)
...
echo
echo "Object Allocation Rate Comparison (ParallelGC)"
echo "----------------------------------------------"
