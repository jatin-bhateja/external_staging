...
public class infer_cond_moves {
 /* 
   Notes:-
    ...
    With small mask value expression a == b for only a faction of total iterations, thus C2 compiler injects 
    an un-common trap in infrequently taken branch.
 ...
 39  Binary  === _ 12 25  [[ 37 ]]
    ...
    Action Item :-
     - Prepare a micro for APX usecase with primary and secondary conditional expressions guarding
       the diamond shaped control structure.
*/
