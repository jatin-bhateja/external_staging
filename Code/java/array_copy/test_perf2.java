...
class test {
  ...
  public static byte workload(byte [] dst, byte [] src, int cnt, boolean print) {
    ...
    // AVX3-32bytes masked operations.
    System.arraycopy(src, 0, dst, 0, 20);
    System.arraycopy(src, 64 , dst, 64 , 20);
    System.arraycopy(src, 128 , dst, 128, 20);
    System.arraycopy(src, 192 , dst, 192, 20);
