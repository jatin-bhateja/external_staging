...
public class FloatColumnFilter {
  ...
  public static void main(String [] args) {
     ...
     MemorySegment ma = MemorySegment.allocateNative(size*4, 64, MemorySession.global());
     MemorySegment mr = MemorySegment.allocateNative(size*4, 64, MemorySession.global());
