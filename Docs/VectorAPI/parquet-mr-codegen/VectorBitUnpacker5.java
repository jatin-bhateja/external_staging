...
public class VectorBitUnpacker5 {

  // Permutation tables.
  static int [] perm_table0 = {
     0,63,0,63,2,63,2,63,
     4,63,6,63,6,63,8,63,
     10,63,10,63,12,63,12,63,
     14,63,16,63,16,63,18,63,
     20,63,20,63,22,63,22,63,
     24,63,26,63,26,63,28,63,
     30,63,30,63,32,63,32,63,
     34,63,36,63,36,63,38,63, 
  };
  static int [] perm_table1 = {
     0,63,2,63,0,63,4,63,
     6,63,0,63,8,63,0,63,
     0,63,12,63,0,63,14,63,
     16,63,0,63,18,63,0,63,
     0,63,22,63,0,63,24,63,
     26,63,0,63,28,63,0,63,
     0,63,32,63,0,63,34,63,
     36,63,0,63,38,63,0,63, 
  };
  // Left shift tables.
  ...
  public static final VectorMask<Byte> input_mask = VectorMask.fromLong(B256,  1048575L);
  
  public static final VectorMask<Short> or_mask = VectorMask.fromLong(S512 ,1515870810L);
  ...
  public static void scalar_packing(byte [] in , int [] out, int ctr) {
     for(int i = 0, j = 0 ; i < in.length-5 ; i+=5, j+= 8) {
  ...
  public static void vector_packing(byte [] in , int [] out, int ctr) {
     int i = 0;
     int j = 0;
     for(; i < in.length-20; i+=20, j+=32) {
        VectorBitUnpacker5.unpack8Values_vec(in, i, out, j);
     }
     for(; i < in.length-5; i+=5, j+= 8) {
        packer.unpack8Values(in, i, out, j);
     }
  }

  public static final BytePacker packer =  ByteBitPackingLE.factory.newBytePacker(5); 
  public static final int SIZE = 512;

  public static void main(String [] args) {
      byte [] in = new byte[SIZE*5];
