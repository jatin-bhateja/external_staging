...
public class VectorBitUnpacker17 {
  ...
  public static final VectorMask<Byte> input_mask = VectorMask.fromLong(B256,  131071L);
  
  public static final VectorMask<Integer> or_mask = VectorMask.fromLong(I256, 255L);
  ...
  public static void scalar_packing(byte [] in , int [] out, int ctr) {
     for(int i = 0, j = 0 ; i < in.length-17 ; i+=17, j+= 8) {
  ...
  public static void vector_packing(byte [] in , int [] out, int ctr) {
     int i = 0;
     int j = 0;
     for(; i < in.length-17; i+=17, j+=8) {
        VectorBitUnpacker17.unpack8Values_vec(in, i, out, j);
     }
  }

  public static final BytePacker packer =  ByteBitPackingLE.factory.newBytePacker(17); 
  public static final int SIZE = 512;

  public static void main(String [] args) {
      byte [] in = new byte[SIZE*17];
